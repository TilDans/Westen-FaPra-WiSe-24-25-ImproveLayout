...
describe('Exclusive Cut function', () => {
    ...
    it('should return two valid Eventlogs when a parallel cut is made', () => {
        ...
        // 1. Parallel Cut: -->A, A-->B, B-->A, C-->B, B-->C, C-->, -->D, D-->B, B-->D
        const edge1: Edge[] = [
        ...
        const resultA: EventLog[] = service.checkParallelCut(eventlog, edge1);
        ...
        // const resultB: EventLog[] = service.checkParallelCut(eventlog, edge2);
